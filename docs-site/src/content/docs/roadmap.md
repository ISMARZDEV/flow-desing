...
draft: false
title: Roadmap
description: Current product direction for AISpaceFlow, separated clearly from already shipped behavior.
---
...
- **MCP Server**: Drive AISpaceFlow from Claude Desktop, Cursor, Windsurf, and other MCP clients
