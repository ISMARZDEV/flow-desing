...
draft: false
title: Node Types
description: AISpaceFlow’teki temel düğüm ailelerini ve bunların hangi diyagram iş akışlarına uyduğunu anlayın.
---

AISpaceFlow hem genel amaçlı hem de aileye özgü düğümleri destekler. Uygulamadaki düğüm modeli akış, mimari, zihin haritası, journey, sınıf, ER, açıklama, gruplama ve medya senaryolarını kapsar.
...
AISpaceFlow ayrıca görsel düğümleri ile browser/mobile wireframe yüzeylerini destekler.
