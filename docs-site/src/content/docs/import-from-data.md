...
Paste your source text, choose the matching mode, and generate the diagram. Depending on the input type, AISpaceFlow either runs a specialized AI-assisted import or a deterministic parser-based flow.
