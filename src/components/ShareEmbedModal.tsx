...
export function ShareEmbedModal({ viewerUrl, onClose }: ShareEmbedModalProps): React.ReactElement {
    ...
    const markdownLink = `[Open interactive diagram on AISpaceFlow](${viewerUrl})`;
    const readmeLink = `[View architecture diagram](${badgeViewerUrl})`;
    const iframeSnippet = `<iframe src="${cardViewerUrl}" width="720" height="420" style="border:0;border-radius:16px;overflow:hidden;" loading="lazy" title="AISpaceFlow diagram"></iframe>`;
